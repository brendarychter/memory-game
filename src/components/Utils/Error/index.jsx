const Error = ()=>{
    return <div className="flex items-center justify-center w-full h-screen px-16 bg-gray-200 md:px-0">
    <div className="flex flex-col items-center justify-center px-4 py-8 bg-white border border-gray-200 rounded-lg shadow-2xl md:px-8 lg:px-24">
        ...
        <p className="py-2 mt-8 text-center text-gray-500 border-y-2">Whoops, something went wrong on our servers.</p>
    </div>
</div>
}
